        ...
        <div className="fixed w-full h-screen top-0 right-0 z-50 flex justify-end ">
            <div className="relative z-30 w-80 bg-white h-screen flex flex-col">
                <div className="text-white bg-black py-3 px-3 text-center flex items-center justify-center">
                    ...
                    <span className="font-medium ml-1">Cart ({selectTotalItem})</span>
                </div>
                ...
                <div className="p-3 border-t-2 border-gray-100 sticky">
                    <button className="quickbutton w-full button font-bold sticky" onClick={() => router.push('/checkout')}>Checkout {" "}
                        <Currency
                            quantity={totalPrice}
                        />
                    </button>
